...
@interface ReplyView ()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (void)createUI {
    ...
    [mainCollectionView registerClass:[ReplyCollectionViewCell class] forCellWithReuseIdentifier:@"cellID"];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ReplyCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cellID" forIndexPath:indexPath];
...
- (int)currentIndex {
    if (_mainCollectionView.contentSize.width == 0 || _mainCollectionView.contentSize.height == 0) {
        return 0;
    }
